...
\begin{longtable}{p{0.06\textwidth}p{0.43\textwidth}p{0.2\textwidth}p{0.2\textwidth}}
\toprule
...
\label{tbl:bom_opt}
\end{longtable}
\includepdf[pages={1}]{robot.pdf}
\includepdf[pages={1}, angle=90]{../hardware/robot_schematic.pdf}
