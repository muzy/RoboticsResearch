...
\item[Open-Source] \hfill \\ Open-Source products can be easily modified, extended and remixed into new, continously improved, products. Schematics, pcb layout files, build-instructions and specifications should be accessible under a permissive open-source license. 
\end{description}
...
\midrule
Affordable      & \stars{5}    & Having a price tag of 50€ renders the Asuro very affordable in comparison to the 100€ limit set. The cost effectiveness is outstanding and features sensors and actuators for basic tasks.     \\
...
Assessment Criteria    & Rating & Description \\
\midrule
Affordable      & \stars{2}    & With a price tag of XXX Euro and XXX Euro for a sensor extension kit the Arduino Robot is far above the price limit of 100€. The price for the basic robot without the sensor extension is very high compared to the features.\\
