...
Interaction with the environment is realized using two DC motors which can be controlled individually in terms of direction and speed. Four LEDs are used for displaying the status of the asuro. The whole system is powered by four AAA batteries or rechargable batteries mounted in a 2x2 battery case. 
